...
import { setOpenAddMembersBox } from "../../../../redux/chatSlice/chatSlice";
import {
    setNewGroupPeoples,
    setSearchPeople,
...
const AddMembersToGroup = () => {
    ...
    const { searchPeople, newGroupPeoples } = useSelector(
        (state: RootState) => state.navbar
    );

    const { openAddMembersBox } = useSelector((state: RootState) => state.chat);
    ...
    const addMemberSubmitHandler = (user: any) => {
        console.log(user);
    };
    ...
    return (
        ...
        >
            <div className="h-full w-full flex justify-center items-center">
                <section
                    className={
                        " w-[600px] h-[600px]   bg-gray-400 dark:bg-slate-800  shadow-xl delay-400 duration-500 ease-in-out overflow-auto transition-all transform rounded-md " +
                        (openAddMembersBox
                            ? " !translate-y-0 "
                            : " translate-y-full ")
                    }
                    ...
                    <div className="w-full h-auto flex flex-col justify-center items-center p-5 gap-5">
                        <div className="w-full">
                            <button
                                ...
                                onClick={() =>
                                    dispatch(setOpenAddMembersBox(false))
                                }
                            >
                                <IoCloseSharp />
                            </button>
